export const config = {
    developer: {
        name: "Abdurrahim",
        fullName: "Abdurrahim Lawal Idah",
    ...
    social: {
        github: "AbdulEedah",
        email: "lawalabdurrahim5401@gmail.com",
        location: "Nigeria"
    },
    about: {
        title: "About Me",
    ...
    experiences: [
        {
            ...
            technologies: ["React", "Next.js", "TailwindCSS", "JavaScript", "TypeScript"]
        },
        {
            ...
            technologies: [ "HTML", "CSS", "React", "Node.js", "Express", "JavaScript"]
        }
    ],
    projects: [
        {
    ...
    contact: {
        email: "lawalabdurrahim5401@gmail.com",
        github: "https://github.com/AbdulEedah",
        linkedin: "https://www.linkedin.com/in/abdurrahim-lawal",
        twitter: "https://x.com/abdurrahimlawa1?s=11",
        instagram: "https://www.instagram.com/the__gentt?igsh=Zno3Nzl0MHI4NXNr&utm_source=qr"
    },
    skills: {
        develop: {
            title: "DEVELOP",
